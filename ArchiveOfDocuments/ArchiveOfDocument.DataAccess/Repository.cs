...
namespace ArchiveOfDocuments.DataAccess
{
    ...
    {
        public Repository(IDbContextFactory<ArchiveOfDocumentsDbContext> contextFactory)
        {
        ...
        private readonly IDbContextFactory<ArchiveOfDocumentsDbContext> _contextFactory;
    }
}